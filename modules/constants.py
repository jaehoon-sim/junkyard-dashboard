...
RAW_TRANSLATIONS = {
    "English": {
        ...
        "period": "Period (Month)", "start_month": "Start Month", "end_month": "End Month"
    },
    "Korean": {
        ...
        "period": "입고 기간 (월)", "start_month": "시작 월", "end_month": "종료 월"
    },
    "Russian": {
        ...
        "period": "Период (Месяц)", "start_month": "Начало", "end_month": "Конец"
    },
    "Arabic": {
        ...
        "period": "الفترة (الشهر)", "start_month": "شهر البدء", "end_month": "شهر الانتهاء"
    }
}